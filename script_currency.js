...
//             const msg = encodeURIComponent(`${amountVal} ${fromCurrency.value} = ${total} ${toCurrency.value}`);
...
//             // Show the popup-currency
//             container.style.display = 'block';
//         })
//         .catch((error) => {
//             console.error("Error fetching exchange rates:", error);
//             alert("Something went wrong while fetching exchange rates. Please try again later.");
//         });
// });
